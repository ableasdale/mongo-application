<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <!-- nav class="navbar navbar-expand-lg bg-light" -->
    <div class="container-fluid">
      <a class="navbar-brand" href="/"><img src="https://ableasdale-tf-mongo-backup.s3.us-east-1.amazonaws.com/images/mdb_white.png" alt="Logo" width="120" height="30"></a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="/largest_and_smallest">Largest and Smallest Cities by State</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
